...
// Récupérer l'historique des marchés du fournisseur
  ...
  async showEditForm(req, res) {
    try {
      ...
      res.render("fournisseurs/modify", {
  ...
  async create(req, res) {
    ...
    if (!raison_sociale || !ice || !domaine_activite_id) {
      ...
      return res.render("fournisseurs/add", {
        ...
        domaines,
        error:
          "La raison sociale, l'ICE et le domaine d'activité sont obligatoires.",
      });
    }
  ...
  async searchByIce(req, res) {
    try {
      ...
      if (!fournisseur) {
        return res
          .status(404)
          .json({ error: "Aucun fournisseur trouvé pour cet ICE." });
      }
